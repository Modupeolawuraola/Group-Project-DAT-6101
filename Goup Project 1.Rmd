...
ggplot(train_data, aes(registered, count))+ geom_point(aes(color= humidity)) + theme_light() +
  labs(x = "Register bike Users", 
       ...
       title = "Register Bike Users Vs Number of bike users During Favourable Weather")
...
ggplot(train_data, aes(x = casual)) + geom_histogram(bins=20,alpha=0.5,fill='red') +
  labs(x= "Casual", 
       y = "Number of Biker Users",
       title= "Casual Bike Users vs Number of Bike Users")
...
```{r Predict number of Bike Users vs Temperature, include='FALSE'}
...
```{r Filtering For 2011 Rentals, include='FALSE'}
...
```{r Filtering for 2012 Rentals, include='FALSE'}
##Filtering for 2012
